...
const services = [
  {
    ...
    content: "Custom designs that speaks your brand",
    imgURL: "/images/graphic_design.png",
    redirectURL: "/services?fashion-design",
  },
  {
    title: "Prints",
    content: "Exclusive artworks designed for your brand",
    imgURL: "/images/prints.png",
    redirectURL: "/services?prints",
  },
  {
    title: "Graphics",
    content: "Captivating graphics for visual storytelling",
    imgURL: "/images/graphics.png",
    redirectURL: "/services?graphics",
  },
  {
    ...
    redirectURL:
      "https://drive.google.com/drive/folders/1Oo5-SZPJEsLUZ2TzPhR2A9V0ahlu8ir0?usp=drive_link",
  },
  {
  ...
  {
    title: "Ecom-Imagery",
    content: "High-converting product shots complimenting Brand story.",
    imgURL: "/images/ecom_imagery.png",
    redirectURL: "/services?ecom-imagery",
  },
];
...
const OurServices = () => {
  return (
    <section
      className="relative w-full mt-[60px] sm:mt-[70px] md:mt-20 lg:mt-[120px]"
      id="services"
    >
      <Image
        src={bubbles}
        ...
        width={1000}
        height={1000}
        className="absolute right-0 -top-10 max-w-[100px] sm:max-w-[120px] md:max-w-[130px] lg:max-w-[140px] w-full h-auto -z-10"
      />

      <Container>
        <h2 className="text-[#0772DC] font-extrabold text-3xl md:text-4xl lg:text-5xl">
          {" "}
          Our services{" "}
        </h2>
        <WateryReveal>
        ...
        {/*  Services Card */}
        <div className="bg-linear-to-b from-[#081E35] to-[#113760] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-[30px] sm:mt-10 md:mt-[45px] lg:mt-[50px] gap-[66px] sm:gap-[88px] px-[50px] py-[42px] rounded-2xl sm:rounded-3xl md:rounded-4xl place-items-center backdrop-blur-md">
